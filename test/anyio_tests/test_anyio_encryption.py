...
"""Test Explicit Encryption with AnyIOMotorClient."""
...
from motor.motor_anyio import AnyIOMotorClientEncryption
...
class TestExplicitSimple(AnyIOTestCase):
    def setUp(self):
        super().setUp()
    ...
    async def test_encrypt_decrypt(self):
        ...
        client_encryption = AnyIOMotorClientEncryption(
    ...
    async def test_codec_options(self):
        ...
        client_encryption_legacy = AnyIOMotorClientEncryption(
            KMS_PROVIDERS, 'keyvault.datakeys', client, opts)
    ...
    async def test_with_statement(self):
        client = self.anyio_client()
        async with AnyIOMotorClientEncryption(
