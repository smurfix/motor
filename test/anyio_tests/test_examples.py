...
"""MongoDB documentation examples with Motor and anyio."""
...
class TestExamples(AnyIOTestCase):
    ...
    async def test_change_streams(self):
        ...
        task = anyio.ensure_future(insert_docs())
    ...
    async def test_transactions(self):
        ...
        AnyIOMotorClient = lambda _: self.cx
        uriString = None
        ...
        client = AnyIOMotorClient(uriString)
